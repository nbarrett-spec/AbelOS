...
const FOOTER = `
  <div style="padding: 24px 32px; text-align: center; color: #999; font-size: 12px; border-top: 1px solid #eee;">
    ...
    <p>Gainesville, TX &middot; <a href="${APP_URL}" style="color: #E67E22;">abellumber.com</a></p>
  </div>
`
  ...
  return sendEmail({
    ...
    html: wrap(`
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="${params.resetUrl}" style="background-color: #E67E22; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px; display: inline-block;">
          Reset Password
        </a>
      </div>
      ...
      <p style="color: #999; font-size: 12px; margin-top: 24px;">
        ...
        <a href="${params.resetUrl}" style="color: #E67E22; word-break: break-all;">${params.resetUrl}</a>
      </p>
    `),
  })
}
...
export async function sendInviteEmail(params: {
  ...
  return sendEmail({
    ...
    html: wrap(`
      <h2 style="color: #1B4F72; margin-top: 0;">Welcome to Abel Lumber!</h2>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
        Hi ${params.firstName},
      </p>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="${params.inviteUrl}" style="background-color: #E67E22; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px; display: inline-block;">
          Set Up Your Account
        </a>
      </div>
      <p style="color: #666; font-size: 13px; line-height: 1.6;">
      ...
      <p style="color: #999; font-size: 12px; margin-top: 24px;">
        Can't click the button? Copy and paste this link: <br>
        <a href="${params.inviteUrl}" style="color: #E67E22; word-break: break-all;">${params.inviteUrl}</a>
      </p>
    `),
  })
}
...
export async function sendStaffPasswordResetEmail(params: {
  ...
  return sendEmail({
    ...
    html: wrap(`
      <h2 style="color: #1B4F72; margin-top: 0;">Password Reset</h2>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
        Hi ${params.firstName}, a password reset was requested for your Abel Operations account.
      </p>
      <div style="text-align: center; margin: 32px 0;">
        <a href="${params.resetUrl}" style="background-color: #1B4F72; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px; display: inline-block;">
          Reset Password
        </a>
      </div>
      <p style="color: #666; font-size: 13px; line-height: 1.6;">
...
export async function sendQuoteReadyEmail(params: {
  ...
  return sendEmail({
    ...
    html: wrap(`
      ...
      <div style="background: #f8f9fa; border-radius: 8px; padding: 20px; margin: 24px 0;">
        <table style="width: 100%; font-size: 14px; color: #333;">
          ...
          <tr>
            ...
            <td style="padding: 6px 0; text-align: right; font-weight: 700; font-size: 18px; color: #1B4F72;">${formattedTotal}</td>
          </tr>
          <tr>
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="${params.quoteUrl}" style="background-color: #E67E22; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px; display: inline-block;">
          View Quote Details
        </a>
      </div>
      <p style="color: #666; font-size: 13px; line-height: 1.6;">
...
export async function sendOrderConfirmationEmail(params: {
  ...
  return sendEmail({
    ...
    html: wrap(`
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="${APP_URL}/dashboard" style="background-color: #1B4F72; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px; display: inline-block;">
          Track Your Order
        </a>
      </div>
      <p style="color: #666; font-size: 13px; line-height: 1.6;">
...
export async function sendQuoteRequestConfirmationEmail(params: {
  ...
  return sendEmail({
    ...
    replyTo: 'quotes@abellumber.com',
    html: wrap(`
      <h2 style="color: #1B4F72; margin-top: 0;">Quote Request Received</h2>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
        Hi ${params.builderName},
      </p>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="${APP_URL}/dashboard/quotes" style="background-color: #1B4F72; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px; display: inline-block;">
          View Your Requests
        </a>
      </div>
      <p style="color: #666; font-size: 13px; line-height: 1.6;">
...
export async function sendInvoiceEmail(params: {
  ...
  return sendEmail({
    ...
    html: wrap(`
      <h2 style="color: #1B4F72; margin-top: 0;">New Invoice</h2>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
        Hi ${params.builderName},
      </p>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
      ...
      <div style="background: #fff8f0; border: 1px solid #f0d0a0; border-radius: 8px; padding: 20px; margin: 24px 0;">
        <table style="width: 100%; font-size: 14px; color: #333;">
          ...
          <tr>
            ...
            <td style="padding: 6px 0; text-align: right; font-weight: 700; font-size: 18px; color: #E67E22;">${formattedTotal}</td>
          </tr>
          <tr>
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="${APP_URL}/dashboard/invoices" style="background-color: #E67E22; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px; display: inline-block;">
          View Invoice
        </a>
      </div>
      <p style="color: #666; font-size: 13px; line-height: 1.6;">
...
export async function sendWarrantyUpdateEmail(params: {
  ...
  const color = statusColors[params.newStatus] || '#1B4F72'
  ...
  return sendEmail({
    ...
    html: wrap(`
      <h2 style="color: #1B4F72; margin-top: 0;">Warranty Claim Update</h2>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
        Hi ${params.builderName},
      </p>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
      ...
      ` : ''}
      <div style="text-align: center; margin: 32px 0;">
        <a href="${APP_URL}/dashboard/warranty" style="background-color: #1B4F72; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px; display: inline-block;">
          View Claim Details
        </a>
      </div>
      <p style="color: #666; font-size: 13px; line-height: 1.6;">
...
export async function sendOrderStatusEmail(params: {
  ...
  return sendEmail({
    ...
    replyTo: 'orders@abellumber.com',
    html: wrap(`
      <h2 style="color: #1B4F72; margin-top: 0;">Order ${label}</h2>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
        Hi ${params.builderName},
      </p>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
      ...
      <div style="background: #f0fdf4; border: 1px solid #86efac; border-radius: 8px; padding: 20px; margin: 24px 0; text-align: center;">
        <p style="margin: 0; font-size: 24px; font-weight: 700; color: #1B4F72;">${label}</p>
...
export async function sendWarrantyClaimConfirmationEmail(params: {
  ...
  return sendEmail({
    ...
    replyTo: 'warranty@abellumber.com',
    html: wrap(`
      <h2 style="color: #1B4F72; margin-top: 0;">Warranty Claim Received</h2>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
        Hi ${params.builderName},
      </p>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
...
export async function sendQuoteFollowUpDay3(params: {
  ...
  return sendEmail({
    ...
    replyTo: 'quotes@abellumber.com',
    html: wrap(`
      <h2 style="color: #1B4F72; margin-top: 0;">Just Checking In</h2>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
        Hi ${params.firstName},
      </p>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
...
export async function sendQuoteFollowUpDay7(params: {
  ...
  return sendEmail({
    ...
    replyTo: 'quotes@abellumber.com',
    html: wrap(`
      <h2 style="color: #E67E22; margin-top: 0;">Quote Expiring Soon</h2>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
        Hi ${params.firstName},
      </p>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
...
export async function sendApplicationReceivedEmail(params: {
  ...
  return sendEmail({
    ...
    html: wrap(`
      <h2 style="color: #1B4F72; margin-top: 0;">Application Received</h2>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
      ...
      <div style="background: #f0f7ff; border: 1px solid #d0e4f7; border-radius: 8px; padding: 20px; margin: 24px 0; text-align: center;">
        ...
        <p style="color: #1B4F72; font-size: 22px; font-weight: 700; font-family: monospace; margin: 0;">${params.refNumber}</p>
      </div>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
...
export async function sendApplicationApprovedEmail(params: {
  ...
  return sendEmail({
    ...
    replyTo: 'sales@abellumber.com',
    html: wrap(`
      <h2 style="color: #1B4F72; margin-top: 0;">Your Account is Approved!</h2>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
        Hi ${params.contactName},
      </p>
      <p style="color: #333; font-size: 15px; line-height: 1.6;">
      ...
      <div style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 8px; padding: 20px; margin: 24px 0;">
        <table style="width: 100%; font-size: 14px; color: #333;">
          ...
          <tr>
            ...
            <td style="padding: 6px 0; text-align: right; font-weight: 700; font-family: monospace; font-size: 16px; color: #1B4F72;">${params.tempPassword}</td>
          </tr>
        </table>
      </div>
      ...
      <div style="text-align: center; margin: 32px 0;">
        <a href="${APP_URL}/login" style="background-color: #E67E22; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; font-size: 15px; display: inline-block;">
          Log In Now
        </a>
      </div>
      <p style="color: #666; font-size: 13px; line-height: 1.6;">
