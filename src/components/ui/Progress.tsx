            ...
            <div className="flex flex-col items-center">
              <div
                className={clsx(
                  ...
                  isComplete && 'bg-abel-navy text-white',
                  isCurrent && 'bg-abel-orange text-white ring-4 ring-abel-orange/20',
              ...
              <span
                className={clsx(
                  ...
                  isCurrent ? 'text-abel-navy dark:text-abel-navy-light' : 'text-gray-500 dark:text-gray-400'
                )}
              >
                {step}
              </span>
            ...
            {!isLast && (
              <div
                className={clsx(
                  ...
                  isComplete ? 'bg-abel-navy' : 'bg-gray-200 dark:bg-gray-700'
                )}
              />
            )}
          </div>
