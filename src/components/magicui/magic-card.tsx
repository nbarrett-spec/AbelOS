    ...
    <motion.div
      ...
      style={{
        background: useMotionTemplate`
          linear-gradient(var(--color-background, var(--portal-bg-card, #FFFFFF)) 0 0) padding-box,
          radial-gradient(${gradientSize}px circle at ${mouseX}px ${mouseY}px,
            ${gradientFrom},
            ${gradientTo},
            var(--color-border, var(--portal-border, #E8DFD0)) 100%
          ) border-box
        `,
      }}
    >
      <div
        ...
        style={{ background: 'var(--color-background, var(--portal-bg-card, #FFFFFF))' }}
      />
