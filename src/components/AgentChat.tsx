...
export default function AgentChat() {
  ...
  function formatContent(text: string) {
    ...
    safe = safe
      ...
      .replace(/\n/g, '<br/>')
      .replace(/\u2022 /g, '&bull; ')
      .replace(/\[([^\]]+)\]\(([^)]+)\)/g, '<a href="$2" style="color:var(--c1, #4F46E5);text-decoration:underline" target="_blank" rel="noopener">$1</a>')
    return safe
  }
    ...
    <>
      <button
        ...
        style={{
          ...
          height: '60px',
          borderRadius: '50%',
          background: 'linear-gradient(135deg, var(--canvas, #080D1A) 0%, var(--c3, #0EA5E9) 100%)',
          color: 'white',
          border: 'none',
          cursor: 'pointer',
          boxShadow: '0 4px 20px rgba(62,42,30,0.4)',
          display: 'flex',
          alignItems: 'center',
        ...
        <div style={{
              ...
              <div key={idx} style={{
                ...
                <div style={{
                  ...
                  background: msg.role === 'user'
                    ? 'linear-gradient(135deg, var(--canvas, #080D1A) 0%, var(--c3, #0EA5E9) 100%)'
                    : 'white',
            ...
            <div style={{
              ...
              {quickActions.map((qa, i) => (
                <button
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = 'var(--canvas, #080D1A)'
                    e.currentTarget.style.color = 'white'
                    e.currentTarget.style.borderColor = 'var(--canvas, #080D1A)'
                  }}
                  onMouseLeave={(e) => {
          ...
          >
            <input
              ...
              onFocus={(e) => { e.currentTarget.style.borderColor = 'var(--canvas, #080D1A)' }}
            ...
            <button
              ...
              style={{
                ...
                height: '40px',
                borderRadius: '50%',
                background: input.trim() ? 'linear-gradient(135deg, var(--canvas, #080D1A) 0%, var(--c3, #0EA5E9) 100%)' : '#e5e7eb',
                color: 'white',
                border: 'none',
