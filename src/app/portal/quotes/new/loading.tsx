export default function PortalNewQuoteLoading() {
  return (
    <div className="space-y-6 animate-pulse">
      <div>
        <div className="h-8 w-56 rounded-md bg-[var(--portal-bg-elevated)]" />
      ...
      <div className="flex gap-3 items-center">
        {[0, 1, 2, 3].map((i) => (
          <div
            key={i}
            className="h-9 w-9 rounded-full bg-[var(--portal-bg-elevated)]"
          />
        ))}
      </div>
      <div
