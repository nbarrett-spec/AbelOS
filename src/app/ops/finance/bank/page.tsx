    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-lg shadow p-6 border-l-4 border-[#C6A24E]">
          ...
          <div className="text-2xl font-bold text-[#C6A24E] mt-2">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="bg-[#C6A24E] text-white px-4 py-2 rounded font-semibold hover:bg-[#D66D11] transition"
          >
            + Add Account
          </button>
        </div>
          ...
          {data?.accounts.map((account) => {
            ...
            return (
              <div key={account.id} className="bg-white rounded-lg shadow p-6">
                ...
                <button className="mt-4 w-full text-sm text-[#C6A24E] hover:text-[#C6A24E] font-semibold">
                  Edit Account
                </button>
              </div>
            )
        ...
        {data?.accounts.length === 0 && (
          <div className="bg-gray-50 rounded-lg p-8 text-center text-gray-500">
            ...
            <button
              ...
              className="mt-4 text-[#C6A24E] hover:text-[#C6A24E] font-semibold"
            >
