  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <button onClick={() => setFilter('ALL')} className={`bg-white rounded-lg shadow-sm border p-4 text-left transition hover:shadow ${filter === 'ALL' ? 'ring-2 ring-[#E67E22]' : ''}`}>
                      ...
                      <div className="flex gap-1">
                        {msg.status === 'OPEN' && (
                          <button
                            ...
                            className="px-3 py-1 bg-[#E67E22] text-white text-xs font-medium rounded hover:bg-[#d35400] transition"
                          >
                            Reply
                          </button>
                        )}
                        {msg.status === 'REPLIED' && (
                          <button
                            onClick={() => { setSelectedMessage(msg); setReplyText('') }}
                            className="px-3 py-1 bg-[#1B4F72] text-white text-xs font-medium rounded hover:bg-[#1a2f4e] transition"
                          >
                            Update Reply
                          </button>
                        )}
          ...
          <div className="bg-white rounded-xl w-full max-w-xl p-6">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#E67E22] focus:border-transparent"
              />
            </div>
