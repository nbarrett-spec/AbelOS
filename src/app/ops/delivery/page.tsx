  ...
  return (
    <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '20px' }}>
      ...
      {deliveries.filter(d => {
        ...
        <div style={{ background: 'linear-gradient(135deg, #1B4F72 0%, #2E86C1 100%)', borderRadius: 12, padding: 20, marginBottom: 24, color: '#fff' }}>
      ...
      >
        <div className="stat-card">
          ...
          <div className="stat-value" style={{ color: '#1B4F72' }}>
            {stats.todayCount}
          </div>
        </div>
        <div className="stat-card">
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <button
              ...
              style={{
                ...
                fontSize: '12px',
                fontWeight: '500',
                backgroundColor: viewMode === 'list' ? '#1B4F72' : 'white',
                color: viewMode === 'list' ? 'white' : '#6B7280',
                border: `1px solid ${viewMode === 'list' ? '#1B4F72' : '#E5E7EB'}`,
                borderRadius: '6px',
                cursor: 'pointer',
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                fontSize: '12px',
                fontWeight: '500',
                backgroundColor: viewMode === 'reorder' ? '#1B4F72' : 'white',
                color: viewMode === 'reorder' ? 'white' : '#6B7280',
                border: `1px solid ${viewMode === 'reorder' ? '#1B4F72' : '#E5E7EB'}`,
                borderRadius: '6px',
                cursor: 'pointer',
              }}
            >
              ...
              return (
                <div key={delivery.id} className="delivery-row">
                  ...
                  <div>
                    ...
                    <div className="delivery-sub" style={{ marginTop: '4px', color: '#1B4F72', fontWeight: '500' }}>
