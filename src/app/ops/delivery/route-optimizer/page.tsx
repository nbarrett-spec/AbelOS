  ...
  if (loading && !routeData) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '400px' }}>
        <div style={{ animation: 'spin 1s linear infinite', width: '32px', height: '32px', border: '3px solid #1B4F72', borderTop: '3px solid transparent', borderRadius: '50%' }} />
      </div>
    )
  }
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end' }}>
            <button
              ...
              style={{
                width: '100%',
                padding: '10px 20px',
                backgroundColor: selectedCrew && !loading ? '#E67E22' : '#ccc',
                color: 'white',
                border: 'none',
                borderRadius: '8px',
                fontSize: '14px',
              ...
              onMouseEnter={(e) => {
                if (selectedCrew && !loading) {
                  (e.target as HTMLButtonElement).style.backgroundColor = '#D35400'
                }
              }}
              onMouseLeave={(e) => {
                if (selectedCrew && !loading) {
                  (e.target as HTMLButtonElement).style.backgroundColor = '#E67E22'
                }
              }}
            >
            ...
            {summaryCards.map((card) => (
              ...
              >
                ...
                <p style={{
                  fontSize: '20px',
                  fontWeight: 'bold',
                  color: card.highlight ? '#27AE60' : '#1B4F72',
                }}>
                  {card.value}
                </p>
              </div>
                ...
                <tbody>
                  {routeData.stops.map((stop) => (
                    <tr key={stop.id} style={{ borderBottom: '1px solid #eee' }}>
                      <td style={{ padding: '12px', fontSize: '14px', fontWeight: '600', color: '#1B4F72' }}>
                        {stop.stopNumber}
                      </td>
                      <td style={{ padding: '12px', fontSize: '14px', color: '#333' }}>
                        <a
                          href={`/ops/delivery/${stop.deliveryId}`}
                          style={{ color: '#1B4F72', textDecoration: 'none', cursor: 'pointer' }}
                        >
                          {stop.address}
                          <br />
          ...
          <div style={{ marginBottom: '32px', backgroundColor: 'white', border: '1px solid #ddd', borderRadius: '8px', padding: '20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px' }}>
              <div>
                ...
                <p style={{ fontSize: '16px', fontWeight: '600', color: '#1B4F72', marginBottom: '4px' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '16px', fontWeight: '600', color: '#1B4F72' }}>
                ...
                <div style={{ gridColumn: '1 / -1' }}>
                  <button
                    ...
                    style={{
                      width: '100%',
                      padding: '10px 16px',
                      backgroundColor: savingSettings ? '#ccc' : '#1B4F72',
                      color: 'white',
                      border: 'none',
                      borderRadius: '6px',
                      fontSize: '14px',
