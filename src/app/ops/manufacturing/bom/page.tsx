      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl border p-6">
          ...
          <input
            ...
            className="w-full px-3 py-2 border rounded-lg text-sm mb-3 focus:ring-2 focus:ring-[#1B4F72] focus:outline-none"
            value={search}
            ...
            {parents.map((p) => (
              <button
                ...
                className={`w-full text-left p-3 rounded-lg border transition-colors ${
                  selectedParent?.id === p.id ? 'border-[#1B4F72] bg-blue-50' : 'border-gray-200 hover:bg-gray-50'
                }`}
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                  <div className="md:col-span-2 relative">
                    <input
                      ...
                      className="w-full px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#1B4F72] focus:outline-none"
                      value={compSearch}
                  ...
                  <select
                    ...
                    className="px-3 py-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#1B4F72] focus:outline-none"
                  >
