          ...
          <div className="col-span-2">
            ...
            <div className="flex flex-wrap gap-2 mt-1">
              {(profile?.roles?.length ? profile.roles : [profile?.role].filter(Boolean)).map((r) => (
                <span
                  key={r}
                  className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-[#1B4F72]/10 text-[#1B4F72]"
                >
                  {ROLE_LABELS[r || ''] || r}
                </span>
              ))}
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          {profileChanged && (
            <button
              ...
              className="bg-[#E67E22] text-white px-4 py-1.5 rounded-lg text-sm font-medium hover:bg-[#d35400] transition disabled:opacity-50"
            >
