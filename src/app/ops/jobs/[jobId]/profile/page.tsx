...
const STATUS_CONFIG: Record<string, { label: string; color: string; bg: string }> = {
  ...
  LOADED: { label: 'T-24 Loaded', color: '#E67E22', bg: 'bg-orange-100 text-orange-700' },
          ...
          {TABS.map((tab) => (
            <button
              ...
              className={`px-4 py-3 text-sm font-semibold whitespace-nowrap border-b-2 transition-colors ${
                activeTab === tab.key
                  ? 'border-[#1B4F72] text-[#1B4F72] dark:text-blue-400 dark:border-blue-400'
        ...
        {job.assignedPM && (
          <SectionCard title="Project Manager">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#1B4F72] flex items-center justify-center text-sm font-bold text-white">
