    ...
    <div style={{ padding: 32, maxWidth: 1200, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 24 }}>
        ...
        <Link href="/apply" target="_blank" style={{
          padding: '8px 16px', borderRadius: 8, backgroundColor: '#C6A24E', color: 'white',
              ...
              <div key={app.id} style={{
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: 16, flex: 1 }}>
                    <div style={{
                      width: 44, height: 44, borderRadius: '50%', backgroundColor: '#0f2a3e', color: 'white',
                ...
                >
                  ...
                  <div style={{ borderTop: '1px solid #f3f4f6', padding: 20 }}>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
                      {/* Contact Info */}
                      <div>
                        <h4 style={{ fontSize: 13, fontWeight: 600, color: '#0f2a3e', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 }}>Contact</h4>
                      ...
                      {/* Business Details */}
                      <div>
                        <h4 style={{ fontSize: 13, fontWeight: 600, color: '#0f2a3e', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 }}>Business</h4>
                        <div style={{ fontSize: 14, color: '#374151', lineHeight: 1.8 }}>
                      ...
                      {notes['Product Interests'] && (
                        <div>
                          <h4 style={{ fontSize: 13, fontWeight: 600, color: '#0f2a3e', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 }}>Product Interests</h4>
                          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                            {notes['Product Interests'].split(', ').map(p => (
                              <span key={p} style={{
                                padding: '4px 12px', borderRadius: 99, fontSize: 12, fontWeight: 500,
                                backgroundColor: '#EBF5FF', color: '#0f2a3e',
                              }}>
                                {p}
                              </span>
                            ))}
                      ...
                      {notes['Current Suppliers'] && (
                        <div>
                          <h4 style={{ fontSize: 13, fontWeight: 600, color: '#0f2a3e', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 }}>Current Suppliers</h4>
                      ...
                      {notes['Additional Notes'] && (
                        <div style={{ gridColumn: '1 / -1' }}>
                          <h4 style={{ fontSize: 13, fontWeight: 600, color: '#0f2a3e', marginBottom: 8, textTransform: 'uppercase', letterSpacing: 0.5 }}>Notes</h4>
