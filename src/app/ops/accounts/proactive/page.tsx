    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={generating}
          className="px-4 py-2 bg-[#1B4F72] text-white text-sm rounded-lg hover:bg-[#1B4F72]/90 disabled:opacity-50"
        >
      ...
      {loading ? (
        <div className="flex items-center justify-center py-20">
          <div className="text-center">
            <div className="w-8 h-8 border-2 border-[#E67E22] border-t-transparent rounded-full animate-spin mx-auto mb-3" />
