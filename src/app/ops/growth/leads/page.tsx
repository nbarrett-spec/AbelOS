...
function ScoreBar({ score, max = 100 }: { score: number; max?: number }) {
  ...
  const color = pct >= 75 ? '#e74c3c' : pct >= 50 ? '#C6A24E' : pct >= 25 ? '#3498db' : '#95a5a6'
  return (
  ...
  return (
    <div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16, marginBottom: 24 }}>
        ...
        <KPICard label="Pipeline Value" value={`$${Number(p.pipelineValue || 0).toLocaleString()}`} sub={`${p.activeQuotes || 0} quotes`} color="#C6A24E" />
  ...
  return (
    <div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, marginBottom: 24 }}>
        ...
        <KPICard label="Warm Leads" value={summary.warm || 0} color="#C6A24E" />
  ...
  return (
    <div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16, marginBottom: 24 }}>
        ...
        <KPICard label="Avg CLV" value={`$${Number(data.avgCLV || 0).toLocaleString()}`} color="#0f2a3e" />
        <KPICard label="$100K+ Accounts" value={dist.over100k || 0} color="#e74c3c" />
        <KPICard label="$50-100K Accounts" value={dist['50k_100k'] || 0} color="#C6A24E" />
      </div>
  ...
  return (
    <div>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16, marginBottom: 24 }}>
        ...
        <KPICard label="Medium Risk" value={s.mediumRisk || 0} color="#C6A24E" sub="90-180 days inactive" />
        <KPICard label="Low Risk" value={s.lowRisk || 0} color="#D4B96A" sub="45-90 days inactive" />
