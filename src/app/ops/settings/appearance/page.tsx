...
const PRESET_COLORS = [
  { hex: '#E67E22', name: 'Orange (Default)' },
...
export default function AppearancePage() {
  ...
  const [customColor, setCustomColor] = useState('#E67E22');
    ...
    const fetchPreferences = async () => {
      try {
        ...
        if (response.ok) {
          ...
          setCustomColor(prefs.accentColor || '#E67E22');
        } else {
  ...
  const accentColor = preferences.accentColor || '#E67E22';
