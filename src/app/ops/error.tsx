  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-6 py-12">
      <div className="max-w-md w-full text-center card p-8">
        ...
        <p className="text-xs font-semibold tracking-wider text-signal uppercase mb-2">Operations</p>
        <h1 className="text-xl font-bold text-brand mb-2">Something went wrong</h1>
