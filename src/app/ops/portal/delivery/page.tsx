      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-xl border p-6">
          ...
          <div className="space-y-2">
            ...
            <Link href="/ops/jobs" className="w-full px-4 py-3 rounded-lg border border-gray-200 hover:bg-orange-50 hover:border-[#E67E22] transition-all text-sm font-medium text-gray-900 block text-center">
              ⚠️ Report Issue
            </Link>
