              ...
              <div>
                ...
                <div className="flex flex-wrap gap-1 mt-1">
                  {categories(selected).map((cat: string, i: number) => (
                    <span key={i} className="bg-[#1B4F72] text-white text-xs px-2 py-0.5 rounded-full">
                      {cat}
                    </span>
                  ))}
                </div>
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded text-xs font-medium border transition
                        ${selected.status === s
                          ...
                          : 'bg-white text-gray-600 border-gray-300 hover:border-[#1B4F72] hover:text-[#1B4F72]'
                        }
