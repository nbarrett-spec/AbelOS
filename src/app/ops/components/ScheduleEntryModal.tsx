            ...
            <div className="flex flex-wrap gap-2">
              {entry.status === 'TENTATIVE' && (
                <button onClick={() => handleStatusChange('FIRM')} disabled={saving}
                  className="px-3 py-1.5 text-sm bg-[#0f2a3e] text-white rounded-lg hover:bg-[#0a1a28] disabled:opacity-50">
                  Confirm (Firm)
                </button>
              )}
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-2">
                <button onClick={handleSave} disabled={saving}
                  className="px-4 py-2 bg-[#0f2a3e] text-white rounded-lg text-sm font-medium hover:bg-[#0a1a28] disabled:opacity-50">
