  ...
  return (
    <div style={{ padding: '32px', maxWidth: '1400px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        <h1 style={{ fontSize: '28px', fontWeight: 700, color: '#1B4F72', marginBottom: '8px' }}>
            ...
            <div key={community.id}>
              ...
              <div
                ...
                style={{
                  backgroundColor: 'white',
                  borderRadius: '12px',
                  border: expandedId === community.id ? `2px solid #E67E22` : '1px solid #e5e7eb',
                  overflow: 'hidden',
                ...
                <div style={{ padding: '20px' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '8px' }}>
                    ...
                    {community.divisionName && (
                      <p style={{ fontSize: '11px', color: '#E67E22', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.5px' }}>
                        {community.divisionName}
                      </p>
                    )}
                    {!community.divisionName && (
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', paddingTop: '16px', borderTop: '1px solid #f3f4f6' }}>
                    <div>
                      <p style={{ fontSize: '20px', fontWeight: 700, color: '#E67E22' }}>
                        {community.totalLots}
                      </p>
                    ...
                    <div>
                      <p style={{ fontSize: '20px', fontWeight: 700, color: '#1B4F72' }}>
              ...
              {expandedId === community.id && (
                ...
                >
                  <div style={{ padding: '20px' }}>
                    <h4 style={{ fontSize: '16px', fontWeight: 700, color: '#1B4F72', marginBottom: '16px' }}>
                      Floor Plans
                    </h4>
                        ...
                        >
                          <thead>
                            <tr style={{ borderBottom: '2px solid #E67E22' }}>
                              <th style={{ padding: '12px 8px', textAlign: 'left', fontWeight: 700, color: '#1B4F72' }}>
                                Name
                              </th>
                              <th style={{ padding: '12px 8px', textAlign: 'center', fontWeight: 700, color: '#1B4F72' }}>
                                Sq Ft
                              </th>
                              <th style={{ padding: '12px 8px', textAlign: 'center', fontWeight: 700, color: '#1B4F72' }}>
                                Beds
                              ...
                              <th style={{ padding: '12px 8px', textAlign: 'right', fontWeight: 700, color: '#1B4F72' }}>
                                Base Price
                              </th>
                            </tr>
                          </thead>
                          <tbody>
                            {community.floorPlans.map((plan, idx) => (
                              ...
                              >
                                ...
                                <td style={{ padding: '12px 8px', textAlign: 'right', color: '#E67E22', fontWeight: 600 }}>
      ...
      {showAddModal && (
        ...
        >
          ...
          >
            {/* Modal Header */}
            <h2 style={{ fontSize: '24px', fontWeight: 700, color: '#1B4F72', marginBottom: '8px' }}>
              Add Community
            </h2>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
              ...
              <div style={{ gridColumn: '1 / -1' }}>
                <label style={{ display: 'block', fontSize: '14px', fontWeight: 600, color: '#1B4F72', marginBottom: '6px' }}>
                  Organization <span style={{ color: '#E67E22' }}>*</span>
                </label>
                <select
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  if (!submitting) {
                    ...
                    e.currentTarget.style.boxShadow = '0 4px 12px rgba(27, 79, 114, 0.3)'
                    e.currentTarget.style.transform = 'translateY(-2px)'
                  }
                }}
                onMouseLeave={(e) => {
