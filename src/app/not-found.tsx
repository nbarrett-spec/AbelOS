  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-6 py-16 bg-gray-50">
      <div className="max-w-lg w-full text-center">
        <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-abel-walnut/10 text-abel-walnut mb-6">
        ...
        <p className="text-sm font-semibold tracking-wider text-abel-amber uppercase mb-2">404</p>
        <h1 className="text-3xl font-bold text-abel-walnut mb-3">Page not found</h1>
