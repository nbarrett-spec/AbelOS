    ...
    <div className="max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="px-4 py-2 bg-signal text-white rounded hover:bg-signal/90 text-sm font-medium"
        >
      ...
      {showMintForm && (
        <div className="mb-6 p-4 bg-white border border-gray-200 rounded-lg">
          ...
          <button
            ...
            className="px-4 py-2 bg-brand text-white rounded text-sm font-medium disabled:opacity-50"
          >
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-3">
          ...
          <button
            ...
            className="px-3 py-1.5 bg-brand text-white rounded text-xs font-medium"
          >
        ...
        {showBuilderAliasForm && (
          <div className="mb-3 p-4 bg-white border border-gray-200 rounded-lg">
            ...
            <button
              ...
              className="px-4 py-2 bg-signal text-white rounded text-sm font-medium disabled:opacity-50"
            >
              Save Alias
            </button>
          </div>
