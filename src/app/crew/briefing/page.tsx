...
function CrewBriefingInner() {
  ...
  if (loading) {
    return (
      <div className="p-4 space-y-4">
        <div className="h-32 bg-gradient-to-r from-[#0f2a3e] to-[#0D2438] rounded-lg animate-pulse" />
  ...
  return (
    <div className="p-4 space-y-4 pb-8">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#0f2a3e] to-[#0D2438] text-white rounded-lg p-5">
      ...
      {briefing.totalStops > 0 && !briefing.allCompleted && (
        <div className="bg-white rounded-lg p-4 border border-gray-200">
          <div className="flex items-center justify-between mb-2">
            ...
            <p className="text-sm font-bold text-[#C6A24E]">{progressPercent}%</p>
          </div>
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div
              className="bg-[#C6A24E] h-2 rounded-full transition-all duration-500"
            ...
            >
              <div className={`rounded-lg p-4 border-2 transition-all hover:shadow-md ${
                stop.status === 'COMPLETED'
                  ...
                  : 'bg-white border-gray-200 hover:border-[#C6A24E]'
              }`}>
                {/* Header */}
                ...
                <div className="flex gap-2 pt-3" onClick={(e) => e.preventDefault()}>
                  ...
                  {stop.status !== 'COMPLETED' && (
                    <button
                      ...
                      className="flex-1 bg-[#C6A24E] hover:bg-[#A8882A] text-white font-semibold py-2 px-3 rounded text-sm transition-colors"
                    >
                      Start
                    </button>
                  )}
