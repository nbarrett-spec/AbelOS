    ...
    <html lang="en">
      <body style={{
        ...
        <div style={{ textAlign: 'center', maxWidth: 520, padding: '32px 24px' }}>
          ...
          <p style={{ fontSize: 12, fontWeight: 700, color: '#C6A24E', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 8 }}>
            Abel Lumber
          </p>
          <h1 style={{ fontSize: 24, fontWeight: 700, color: '#0f2a3e', marginBottom: 12, margin: 0 }}>
            Platform error
          </h1>
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
            <button
              ...
              style={{
                ...
                backgroundColor: '#0f2a3e', color: 'white',
          ...
          <p style={{ marginTop: 24, fontSize: 13, color: '#9ca3af' }}>
            Support:{' '}
            <a href="mailto:support@abellumber.com" style={{ color: '#0f2a3e', textDecoration: 'none', fontWeight: 500 }}>
