    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-6 flex gap-3 flex-wrap">
        <input
          ...
          className="flex-1 min-w-[200px] px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1B4F72]"
        />
      </div>
      ...
      {loading && !orders.length ? (
        <div className="bg-white rounded-lg border p-16 flex items-center justify-center">
          <div className="w-6 h-6 border-3 border-[#1B4F72] border-t-transparent rounded-full animate-spin" />
        </div>
      ) : orders.length === 0 ? (
            ...
            {reorderModal.loading ? (
              ...
              <>
                    ...
                    <tbody>
                      {reorderModal.items.map(item => (
                        ...
                        >
                          ...
                          <td className={`px-3 py-3 text-right font-medium ${item.priceChanged ? 'text-[#E67E22]' : 'text-gray-900'}`}>
                            {fmt(item.currentUnitPrice)}
                            {item.priceChanged && (
                              <div className="text-xs text-[#E67E22]">
                ...
                <div className="flex gap-3">
                  <button
                    onClick={addToCart}
                    className="flex-1 px-4 py-2 bg-[#E67E22] hover:bg-[#d35400] text-white font-semibold rounded-lg transition"
                  >
              ...
              {isCompleted && (
                <>
                  <button
                    ...
                    className="flex-1 bg-[#E67E22] hover:bg-[#d35400] text-white font-semibold text-sm py-2 rounded transition"
                  >
                    Reorder
                  </button>
                  <button
                    ...
                    className="flex-1 bg-[#1B4F72] hover:bg-[#1B4F72]/90 text-white font-semibold text-sm py-2 rounded transition"
                  >
                    Save as Template
                  </button>
                </>
