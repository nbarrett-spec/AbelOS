...
export default function SavingsPage() {
  ...
  const styles = {
    ...
    tierName: { fontSize: '1.5rem', fontWeight: '600', color: '#1B4F72' },
    ...
    metricValue: { fontWeight: '600', color: '#1B4F72' },
  ...
  return (
    <div style={styles.container}>
      <h1 style={{ fontSize: '2rem', fontWeight: '700', color: '#1B4F72', marginBottom: '2rem' }}>Volume Savings</h1>
      ...
      <div style={styles.grid}>
        <div style={styles.card}>
          <h3 style={{ fontSize: '1.1rem', fontWeight: '600', color: '#1B4F72', marginBottom: '1rem' }}>
            Savings Calculator
          </h3>
          ...
          <div style={{ display: 'grid', gap: '1rem' }}>
            {data.estimatedSavingsAtEachTier.map((tier) => (
              <div
                ...
                style={{
                  padding: '1rem',
                  backgroundColor: tier.tier === data.currentTier ? '#E67E2220' : '#f9f9f9',
                  borderRadius: '8px',
                  border: tier.tier === data.currentTier ? '1px solid #E67E22' : '1px solid #e0e0e0',
                }}
              >
                ...
                {tier.tier === data.currentTier && (
                  <p style={{ fontSize: '0.75rem', color: '#E67E22', marginTop: '0.5rem', fontWeight: '600' }}>
                    ✓ Your current tier
                  </p>
                )}
              </div>
