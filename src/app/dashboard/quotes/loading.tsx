        ...
        {[...Array(6)].map((_, i) => (
          <div key={i} className="bg-white rounded-xl border border-border p-5">
            ...
            <div className="space-y-2 mb-4">
              <div className="h-3 bg-surface-muted rounded w-40" />
              <div className="h-3 bg-surface-muted rounded w-36" />
              <div className="h-3 bg-surface-muted rounded w-44" />
            </div>

            {/* Status badge */}
            <div className="h-6 bg-surface-muted rounded w-24 mb-4" />

            {/* Actions */}
            <div className="flex gap-2">
              <div className="h-8 bg-surface-muted rounded flex-1" />
              <div className="h-8 bg-surface-muted rounded flex-1" />
            </div>
          </div>
        ))}
