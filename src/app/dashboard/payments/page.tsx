  ...
  if (authLoading) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '60vh' }}>
        <div style={{ width: 32, height: 32, border: '4px solid #1B4F72', borderTop: 'transparent', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
      </div>
    )
  }
  ...
  if (!builder) {
    return (
      <div style={{ textAlign: 'center', paddingTop: 80 }}>
        ...
        <Link href="/login" style={{ display: 'inline-block', padding: '8px 24px', backgroundColor: '#E67E22', color: 'white', borderRadius: 8, fontWeight: 600, textDecoration: 'none' }}>Sign In</Link>
      </div>
    )
  }
    ...
    <div style={{ maxWidth: '1200px' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16, marginBottom: 32 }}>
        <div style={{ backgroundColor: 'white', border: '1px solid #e5e5e5', borderRadius: 12, padding: 20 }}>
          ...
          <p style={{ fontSize: 24, fontWeight: 700, color: '#1B4F72', marginBottom: 4 }}>{formatCurrency(totalOutstanding)}</p>
        ...
        <div style={{ backgroundColor: 'white', border: '1px solid #e5e5e5', borderRadius: 12, padding: 20 }}>
          ...
          <p style={{ fontSize: 24, fontWeight: 700, color: overdueInvoices.length > 0 ? '#E74C3C' : '#1B4F72', marginBottom: 4 }}>
        ...
        <div style={{ backgroundColor: 'white', border: '1px solid #e5e5e5', borderRadius: 12, padding: 20 }}>
          ...
          <p style={{ fontSize: 24, fontWeight: 700, color: '#1B4F72', marginBottom: 4 }}>
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 4 }}>
                      <span style={{ fontSize: 14, fontWeight: 600, color: '#1B4F72', fontFamily: 'monospace' }}>
        ...
        <div style={{
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap' }}>
            <div style={{ flex: 1, minWidth: 250 }}>
              ...
              <p style={{ fontSize: 18, fontWeight: 700, color: '#1B4F72' }}>Total: {formatCurrency(selectedTotal)}</p>
            </div>
            ...
            <button
              ...
              style={{
                padding: '10px 24px',
                backgroundColor: submitting ? '#9ca3af' : '#1B4F72',
                color: 'white',
                border: 'none',
                borderRadius: 8,
                fontSize: 14,
