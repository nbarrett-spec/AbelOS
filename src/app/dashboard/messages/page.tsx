    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="bg-[#E67E22] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#d35400] transition flex items-center gap-2"
        >
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="bg-[#1B4F72] text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-[#153d5a] transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          {loading ? (
            ...
            <div className="bg-white rounded-lg border p-16 text-center">
              ...
              <button
                ...
                className="bg-[#E67E22] text-white px-5 py-2 rounded-lg font-medium text-sm hover:bg-[#d35400] transition"
              >
                ...
                return (
                  <div
                    ...
                    className={`bg-white rounded-lg border p-4 cursor-pointer hover:shadow-sm transition ${
                      selected?.id === msg.id ? 'ring-2 ring-[#1B4F72]' : ''
