    ...
    <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-xl border p-6">
          ...
          {projects.length === 0 ? (
            <div className="text-center py-8">
              ...
              <Link
                href="/projects/new"
                className="px-5 py-2.5 bg-[#1B4F72] hover:bg-[#15405e] text-white font-semibold rounded-xl transition"
              >
      ...
      {step === 'upload' && (
        <div className="space-y-4">
          ...
          <div className="bg-[#1B4F72]/5 border border-[#1B4F72]/20 rounded-xl p-4 flex items-center justify-between">
            <div>
          ...
          <div
            ...
            className={`border-2 border-dashed rounded-xl p-12 text-center cursor-pointer transition ${
              isDragging
                ...
                : 'border-gray-300 hover:border-[#1B4F72] hover:bg-gray-50'
            }`}
          >
            <input
              ref={fileInputRef}
          ...
          {files.length > 0 && (
            <button
              ...
              disabled={uploading}
              className="w-full py-3.5 bg-[#E67E22] hover:bg-[#D35400] text-white font-bold rounded-xl shadow-lg transition disabled:opacity-50 text-lg"
            >
