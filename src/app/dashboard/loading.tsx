export default function Loading() {
  return (
    <div className="space-y-6 animate-pulse">
      {/* Page header */}
      <div>
        <div className="h-8 bg-surface-muted rounded w-64 mb-2" />
          ...
          <div className="bg-white rounded-xl border border-border p-6">
            ...
            {[...Array(3)].map((_, i) => (
              <div key={i} className="py-4 border-b border-border last:border-0">
                <div className="h-4 bg-surface-muted rounded w-48 mb-2" />
                <div className="h-3 bg-surface-muted rounded w-64" />
              </div>
            ))}
          </div>
          ...
          <div className="bg-white rounded-xl border border-border p-6">
            ...
            {[...Array(4)].map((_, i) => (
              <div key={i} className="flex gap-4 py-3 border-b border-border last:border-0">
                ...
                <div className="h-4 bg-surface-muted rounded w-40 flex-1" />
          ...
          <div className="bg-white rounded-xl border border-border p-6">
            ...
            {[...Array(3)].map((_, i) => (
              <div key={i} className="py-3 border-b border-border last:border-0">
                <div className="h-3 bg-surface-muted rounded w-32 mb-2" />
