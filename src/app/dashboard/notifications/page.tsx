    ...
    <div className="min-h-screen bg-surface-muted">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        {isLoading ? (
          ...
          <div className="bg-surface rounded-lg border border-border py-12 text-center">
          ...
          <div className="space-y-3">
            ...
            {filteredNotifications.map(notif => {
              ...
              return (
                <div
                  key={notif.id}
                  className={`${colors.border} bg-surface border border-border rounded-lg p-4 transition hover:shadow-md cursor-pointer ${
                      ...
                      <div className="flex items-start justify-between gap-3">
                        ...
                        {!notif.read && (
                          <div className="flex-shrink-0">
                            <span className="inline-block w-3 h-3 bg-signal rounded-full"></span>
                          </div>
                        )}
                      </div>

                      {notif.link && (
                        <div className="mt-3 flex items-center gap-2 text-sm text-signal hover:text-signal/80 font-medium">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <Link
          href="/dashboard"
          className="inline-flex items-center gap-2 text-signal hover:text-signal/80 font-medium"
        >
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
