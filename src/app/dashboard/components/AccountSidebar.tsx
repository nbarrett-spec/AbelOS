    ...
    <div className="space-y-5">
      ...
      {accountRep && (
        <Card variant="default" padding="md" rounded="2xl" className="animate-enter animate-enter-delay-1">
          <div className="flex items-center gap-2 mb-4">
            <div className="w-5 h-5 rounded flex items-center justify-center text-abel-navy dark:text-abel-navy-light">
          ...
          <div className="space-y-2 mb-4">
            {accountRep.email && (
              <a
                ...
                className="flex items-center gap-2.5 text-sm text-gray-600 dark:text-gray-300 hover:text-abel-navy dark:hover:text-abel-navy-light transition-colors"
              >
      ...
      {paymentSummary && (
        <Card variant="default" padding="md" rounded="2xl" className="animate-enter animate-enter-delay-2">
          <div className="flex items-center gap-2 mb-4">
            <FileText className="w-4 h-4 text-abel-orange" />
      ...
      {lifetimeStats && (
        <Card variant="default" padding="md" rounded="2xl" className="animate-enter animate-enter-delay-4">
          <div className="flex items-center gap-2 mb-4">
            <Award className="w-4 h-4 text-abel-orange" />
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-sm font-bold text-abel-orange">{formatCurrency(lifetimeStats.lifetimeValue)}</span>
            </div>
            <div className="flex justify-between items-center pt-2.5 border-t border-gray-100 dark:border-gray-800">
