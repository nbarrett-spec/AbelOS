    ...
    <Card variant="glass" padding="none" rounded="2xl" className="overflow-hidden animate-enter animate-enter-delay-3">
      ...
      <div className="px-6 py-4 border-b border-border/50 dark:border-border/50 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h3 className="text-sm font-bold text-fg">Smart Insights</h3>
            <p className="text-[11px] text-fg-muted">AI-powered recommendations</p>
          </div>
        </div>
        <Link
          href="/dashboard/intelligence"
          className="inline-flex items-center gap-1 text-xs font-semibold text-brand dark:text-brand-hover hover:text-fg dark:hover:text-white transition-colors group"
        >
          View All
      ...
      <div className="p-5 grid grid-cols-1 md:grid-cols-3 gap-3">
        {/* Reorder Alerts */}
        <div className="group bg-surface/60 rounded-xl border border-border/60 dark:border-border/60 p-4 transition-all hover:border-danger-200 dark:hover:border-danger-800/50 hover:shadow-sm">
          ...
          <h4 className="text-sm font-semibold text-fg mb-1">Reorder Alerts</h4>
        ...
        {/* Savings */}
        {ytdSavings > 0 && (
          <div className="group bg-surface/60 rounded-xl border border-border/60 dark:border-border/60 p-4 transition-all hover:border-success-200 dark:hover:border-success-800/50 hover:shadow-sm">
            ...
            <h4 className="text-sm font-semibold text-fg mb-1">YTD Savings</h4>
            <p className="text-2xl font-bold text-success-600 dark:text-success-400 mb-1 tracking-tight">
              ${(ytdSavings / 1000).toFixed(1)}k
            </p>
            <p className="text-xs text-fg-muted">through tiered pricing</p>
          </div>
        )}

        {/* Price Intelligence */}
        <div className="group bg-surface/60 rounded-xl border border-border/60 dark:border-border/60 p-4 transition-all hover:border-warning-200 dark:hover:border-warning-800/50 hover:shadow-sm">
          ...
          <h4 className="text-sm font-semibold text-fg mb-1">Price Intelligence</h4>
          <p className="text-xs text-fg-muted leading-relaxed">
