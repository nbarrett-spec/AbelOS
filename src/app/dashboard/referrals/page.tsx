...
const REFERRAL_STATUSES = [
  ...
  { key: 'SIGNED_UP', label: 'Signed Up', color: '#C6A24E' },
  { key: 'FIRST_ORDER', label: 'First Order', color: '#27AE60' },
  { key: 'CREDITED', label: 'Credited', color: '#D4B96A' },
]
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '2rem' }}>
      ...
      <div style={{ marginBottom: '3rem' }}>
        <Link href="/dashboard" style={{ fontSize: '0.875rem', color: '#0f2a3e', textDecoration: 'none' }}>
          ← Back to Dashboard
        </Link>
      ...
      >
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '2rem', marginBottom: '2rem' }}>
          <div>
            <div style={{ fontSize: '2rem', fontWeight: 'bold', color: '#0f2a3e' }}>
          ...
          <div>
            <div style={{ fontSize: '2rem', fontWeight: 'bold', color: '#C6A24E' }}>
            ...
            <>
              ...
              <button
                ...
                style={{
                  ...
                  backgroundColor: copiedCode === referrals[0].referralCode ? '#27AE60' : '#0f2a3e',
                  color: '#fff',
                  border: 'none',
                  borderRadius: '0.5rem',
                  cursor: 'pointer',
                    ...
                    <div>
                      ...
                      <div
                        style={{
                          fontSize: '0.875rem',
                          fontWeight: '600',
                          color: ref.referrerCredited ? '#27AE60' : '#D4B96A',
                        }}
                      >
