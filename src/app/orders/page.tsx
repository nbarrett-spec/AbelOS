    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6 sm:mb-8">
          ...
          <Link href="/dashboard" className="text-sm text-[#0f2a3e] hover:underline">← Back to Dashboard</Link>
        </div>
          ...
          <div className="space-y-4">
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2 sm:gap-0 mb-4">
                    ...
                    <div className="sm:text-right">
                      <p className="text-lg sm:text-xl font-bold text-[#0f2a3e]">${order.total?.toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
                  ...
                  <div className="relative">
                    <div className="h-2 bg-gray-100 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-[#0f2a3e] to-[#C6A24E] rounded-full transition-all duration-500"
            ...
            {orders.length > visibleCount && (
              <button
                ...
                className="w-full py-3 text-sm font-medium text-[#0f2a3e] bg-white border border-[#0f2a3e]/20 rounded-xl hover:bg-[#0f2a3e]/5 transition"
              >
