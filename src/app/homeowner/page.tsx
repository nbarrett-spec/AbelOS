  ...
  return (
    <div className="max-w-lg mx-auto pt-8">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="bg-gradient-to-r from-[#0f2a3e] to-[#153d56] px-6 py-8 text-center">
        ...
        <form onSubmit={handleSubmit} className="px-6 py-6 space-y-4">
          <div>
            ...
            <input
              ...
              disabled={loading}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#0f2a3e]/30 focus:border-[#0f2a3e] disabled:opacity-50"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-[#C6A24E] text-white rounded-lg font-semibold text-sm hover:bg-[#A8882A] transition-colors disabled:opacity-50"
          >
            {loading ? (
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={item.step} className="flex gap-3">
              <div className="w-7 h-7 rounded-full bg-[#0f2a3e] text-white text-xs font-bold flex items-center justify-center flex-shrink-0 mt-0.5">
                {item.step}
              </div>
              <div>
