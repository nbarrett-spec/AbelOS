      ...
      <header className="bg-[#1B4F72] text-white">
        <div className="max-w-5xl mx-auto px-4 py-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-[#E67E22] text-xs font-medium">Door & Hardware Selection Portal</p>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="text-center sm:text-left">
            ...
            <p className="text-xs text-gray-400">
              <a href="tel:18002235667" className="hover:text-[#1B4F72]">1-800-ABEL-DOORS</a>
              {' · '}
              <a href="mailto:homeowners@abellumber.com" className="hover:text-[#1B4F72]">homeowners@abellumber.com</a>
            </p>
          </div>
