    ...
    <div className="max-w-4xl">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-8 mb-8">
        ...
        <div
          ...
          className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center cursor-pointer hover:border-[#0f2a3e] hover:bg-blue-50 transition mb-6"
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            className="w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-[#0f2a3e]/20 focus:border-[#0f2a3e] resize-none"
            rows={3}
          />
        </div>
          ...
          {uploadState.blueprints.some((bp) => bp.status === 'READY') && (
            <div className="mt-6 pt-6 border-t border-gray-200">
              <Link
                ...
                className="inline-block bg-[#C6A24E] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#d46d1a] transition"
              >
