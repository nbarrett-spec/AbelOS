      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              href="/sales/pipeline"
              className="text-sm text-[#C6A24E] hover:text-[#A8882A] font-medium"
            >
              View All →
            </Link>
          </div>
          ...
          {myDeals.length > 0 ? (
            <div className="space-y-3 max-h-96 overflow-y-auto">
              {myDeals.slice(0, 5).map((deal) => (
                <Link
                  ...
                  className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:border-[#C6A24E] hover:bg-gray-50 transition"
                >
            ...
            <div className="text-center py-8">
              ...
              <Link
                href="/sales/deals"
                className="text-sm text-[#C6A24E] hover:text-[#A8882A] font-medium mt-2 inline-block"
              >
          ...
          {followUps.length > 0 ? (
            <div className="space-y-3 max-h-96 overflow-y-auto">
              {followUps.map((followUp) => (
                <div
                  key={followUp.id}
                  className="p-3 border border-gray-200 rounded-lg hover:border-[#C6A24E] transition"
                >
