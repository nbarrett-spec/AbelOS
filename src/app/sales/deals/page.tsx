      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <Link
              ...
              className="px-4 py-2 bg-[#C6A24E] text-white rounded-lg font-semibold hover:bg-[#A8882A] transition"
            >
              + New Deal
            </Link>
          </div>
        ...
        <div className="flex gap-4 items-center flex-wrap">
          <input
            ...
            className="flex-1 min-w-64 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C6A24E]"
          />
          <button
              ...
              <tr className="bg-gray-50 border-b border-gray-200">
                <th className="px-6 py-3 text-left">
                  <button
                    ...
                    className="text-sm font-semibold text-gray-900 hover:text-[#C6A24E] transition flex items-center gap-1"
                  >
                    Company
                    {sortField === 'company' && (
                  ...
                  >
                    <td className="px-6 py-4">
                      <Link
                        ...
                        className="text-gray-900 font-semibold hover:text-[#C6A24E] transition"
                      >
                        {deal.companyName}
                      </Link>
