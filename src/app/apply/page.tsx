      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-6">
        <div className="max-w-lg w-full text-center">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 mb-8">
            ...
            <p className="text-2xl font-mono font-bold text-[#1B4F72]">{refNumber}</p>
            <p className="text-xs text-gray-400 mt-2">Save this for your records</p>
          </div>
          <div className="bg-[#1B4F72]/5 rounded-2xl p-6 text-left">
            <h3 className="font-semibold text-[#1B4F72] mb-3">What happens next?</h3>
            <ol className="space-y-3 text-sm text-gray-600">
              <li className="flex gap-3">
                <span className="w-6 h-6 rounded-full bg-[#E67E22] text-white text-xs flex items-center justify-center flex-shrink-0 mt-0.5">1</span>
                <span>Our team reviews your application and verifies your business details</span>
              </li>
              <li className="flex gap-3">
                <span className="w-6 h-6 rounded-full bg-[#E67E22] text-white text-xs flex items-center justify-center flex-shrink-0 mt-0.5">2</span>
                <span>You&apos;ll receive an email with your account credentials and login details</span>
              </li>
              <li className="flex gap-3">
                <span className="w-6 h-6 rounded-full bg-[#E67E22] text-white text-xs flex items-center justify-center flex-shrink-0 mt-0.5">3</span>
          ...
          <div className="mt-8 flex gap-3 justify-center">
            ...
            <Link href="/login" className="px-6 py-3 rounded-xl bg-[#1B4F72] text-white hover:bg-[#1B4F72]/90 transition font-medium">
              Sign In
            </Link>
          </div>
        </div>
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            <div className="w-10 h-10 bg-[#E67E22] rounded-xl flex items-center justify-center font-bold text-white text-sm">
              AB
            </div>
            <span className="font-semibold text-xl text-[#1B4F72]">Abel Builder</span>
          </Link>
          <Link href="/login" className="text-sm text-[#1B4F72] hover:text-[#E67E22] transition font-medium">
          ...
          {[
            ...
            <div key={s.n} className="flex items-center">
              <div className="flex flex-col items-center">
                ...
                <span className={`text-xs mt-1.5 font-medium ${step >= s.n ? 'text-[#1B4F72]' : 'text-gray-400'}`}>
                  {s.label}
                </span>
              </div>
              {i < 3 && (
                <div className={`w-16 sm:w-24 h-0.5 mx-2 mb-5 ${step > s.n ? 'bg-[#E67E22]' : 'bg-gray-200'}`} />
              )}
            </div>
          ))}
        </div>
        ...
        <div className="max-w-2xl mx-auto">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-8">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#E67E22]/30 focus:border-[#E67E22] outline-none transition"
              ...
              <div className="mt-8 flex justify-end">
                <button onClick={nextStep} className="px-8 py-3 bg-[#E67E22] text-white rounded-xl font-semibold hover:bg-[#D35400] transition">
                  Continue
                </button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-8">
              ...
              <div className="space-y-5">
                      ...
                      <button
                        ...
                        className={`text-left px-4 py-3 rounded-xl border-2 transition text-sm font-medium ${
                          form.businessType === type
                            ? 'border-[#E67E22] bg-orange-50 text-[#1B4F72]'
                ...
                <div>
                  ...
                  <textarea
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#E67E22]/30 focus:border-[#E67E22] outline-none transition resize-none"
                    rows={3}
              ...
              <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {PRODUCT_INTERESTS.map(p => (
                      ...
                      >
                        ...
                        {form.productInterests.includes(p.id) && (
                          <svg className="w-4 h-4 text-[#E67E22] inline ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                          </svg>
                        )}
                      </button>
                ...
                <div>
                  ...
                  {(form.referralSource === 'Another Builder' || form.referralSource === 'Abel Sales Rep' || form.referralSource === 'Other') && (
                    <input
                      className="w-full mt-3 px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#E67E22]/30 focus:border-[#E67E22] outline-none transition"
          ...
          {step === 4 && (
            <div className="space-y-6">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="font-semibold text-[#1B4F72]">Company Information</h3>
                      <button onClick={() => setStep(1)} className="text-sm text-[#E67E22] hover:underline">Edit</button>
                    </div>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="font-semibold text-[#1B4F72]">Business Details</h3>
                      <button onClick={() => setStep(2)} className="text-sm text-[#E67E22] hover:underline">Edit</button>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-4 space-y-2 text-sm">
                      <div className="flex justify-between">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <h3 className="font-semibold text-[#1B4F72]">Products & Volume</h3>
                      <button onClick={() => setStep(3)} className="text-sm text-[#E67E22] hover:underline">Edit</button>
                    </div>
                    <div className="bg-gray-50 rounded-xl p-4 space-y-2 text-sm">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {form.productInterests.map(id => {
                              ...
                              return (
                                <span key={id} className="inline-flex px-3 py-1 bg-[#1B4F72]/10 text-[#1B4F72] rounded-full text-xs font-medium">
                                  {product?.label || id}
                                </span>
                              )
                            })}
              ...
              {/* Value Props */}
              <div className="bg-[#1B4F72]/5 rounded-2xl p-6">
                <h3 className="font-semibold text-[#1B4F72] mb-3">What you get with Abel Builder</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-700">
                  <div className="flex gap-2">
                    <svg className="w-5 h-5 text-[#E67E22] flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
              ...
              <div className="flex gap-3 justify-between">
                ...
                <button
                  ...
                  disabled={loading}
                  className="px-10 py-3 bg-[#E67E22] text-white rounded-xl font-bold hover:bg-[#D35400] transition disabled:opacity-50 disabled:cursor-not-allowed"
                >
