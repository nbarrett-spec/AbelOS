  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F5F6FA', fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      <div style={{ maxWidth: 480, margin: '0 auto', padding: '0 16px 32px' }}>
        {/* Header */}
        <div style={{ padding: '20px 0 12px', textAlign: 'center', borderBottom: '3px solid #C6A24E' }}>
          <div style={{ fontSize: 22, fontWeight: 800, color: '#0f2a3e', letterSpacing: -0.5 }}>ABEL LUMBER</div>
  ...
  return (
    <Shell>
      ...
      <div style={{ background: 'white', borderRadius: 12, marginTop: 16, overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
        <div style={{ background: '#0f2a3e', padding: '16px 20px', color: 'white' }}>
        ...
        <div style={{ padding: 20 }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{ fontSize: 13, fontWeight: 700, color: '#0f2a3e', marginBottom: 8 }}>Door Specifications</div>
          ...
          {door.components?.length > 0 && (
            <div style={{ marginBottom: 16 }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: '#0f2a3e', marginBottom: 8 }}>Components</div>
          ...
          {/* Key Dates */}
          <div style={{ marginBottom: 16 }}>
            <div style={{ fontSize: 13, fontWeight: 700, color: '#0f2a3e', marginBottom: 8 }}>Timeline</div>
            {[
          ...
          {door.warranty?.careInstructions && (
            <div style={{ marginBottom: 16 }}>
              <div style={{ fontSize: 13, fontWeight: 700, color: '#0f2a3e', marginBottom: 8 }}>Care Instructions</div>
      ...
      {!showServiceForm && !submitted && (
        <button onClick={() => setShowServiceForm(true)} style={{
          ...
          background: '#C6A24E', color: 'white', border: 'none',
      ...
      {showServiceForm && !submitted && (
        <div style={{ background: 'white', borderRadius: 12, marginTop: 16, padding: 20, boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
          <div style={{ fontSize: 16, fontWeight: 700, color: '#0f2a3e', marginBottom: 16 }}>Request Service</div>
          {[
          ...
          <button onClick={submitService} disabled={submitting || !serviceData.description}
            style={{
              ...
              background: serviceData.description ? '#0f2a3e' : '#ccc',
    ...
    <Shell>
      ...
      <div style={{ background: 'white', borderRadius: 12, marginTop: 16, overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
        ...
        <div style={{ padding: 16 }}>
          ...
          {/* Timeline */}
          <div style={{ marginBottom: 16 }}>
            <div style={{ fontSize: 12, fontWeight: 700, color: '#0f2a3e', marginBottom: 8 }}>LIFECYCLE</div>
            {[
      ...
      <div style={{ background: 'white', borderRadius: 12, marginTop: 12, padding: 16, boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
        <div style={{ fontSize: 12, fontWeight: 700, color: '#0f2a3e', marginBottom: 12 }}>ACTIONS</div>
        ...
        {/* Deliver */}
        {status === 'STAGED' && (
          <ActionBtn label="Confirm Delivered" color="#C6A24E" loading={actionLoading}
      ...
      {door.events?.length > 0 && (
        <div style={{ background: 'white', borderRadius: 12, marginTop: 12, padding: 16, boxShadow: '0 2px 8px rgba(0,0,0,0.08)' }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: '#0f2a3e', marginBottom: 8 }}>EVENT LOG</div>
